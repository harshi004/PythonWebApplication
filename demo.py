...
with col1:
  st.subheder("Pomeranian")
  st.image("./Dog1.jpg",caption="Pomeranian",width=300,use_column_width=True)
  st.write("The Pomeranian is a tiny dog")
with col2:
  st.subheader("Shih Tzu")
  st.image("./Shih Tzu.jpg",caption="Shih Tzu",width=300,use_column_width=True)
