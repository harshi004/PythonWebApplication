...
with col1:
  ...
  st.image("https://m.media-amazon.com/images/M/MV5BNTkzNjJhYjQtNjU0Yy00Y2M3LWI2ZDgtNDRhZmNlNDFjMjQ5XkEyXkFqcGdeQXVyODk2ODI3MTU@._V1_FMjpg_UX1000_.jpg",caption="Pomeranian",width=300,use_column_width=True)
  st.write("Doremon is a cartoon character,which helps to Nobita")
with col2:
  st.subheader("DOREMON Gif")
  st.image("https://i.pinimg.com/originals/59/30/74/593074c302700c41ae6fdfeca3d51563.gif",caption="Shih Tzu",width=300,use_column_width=True)
